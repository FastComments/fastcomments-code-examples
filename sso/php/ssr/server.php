...
class Server
{
    ...
    private $TENANT_ID = 'demo'; // REPLACE THIS WITH YOUR TENANT ID
    private $PAGE_URL_OR_ID = 'test'; // REPLACE THIS WITH YOUR PAGE URL OR ARTICLE ID
    ...
    public function render()
    {
        ...
        $sso_query_string = rawurlencode(json_encode($sso_payload));
